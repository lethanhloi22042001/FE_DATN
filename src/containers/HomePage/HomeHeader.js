                    ...
                    <div className="home-header-content">
                        <div className="left-content">
                            <i class="fas fa-bars"></i>
                                <img className="left-content_img"
                        ...
                        <div className="center-content">
                            ...
                            <div className="child-content">
                                <div><b><FormattedMessage id="homeheader.doctor1" /></b></div>
                        ...
                        <div className="right-content">
                            ...
                            <div className="language-vi"><span onClick={ (event)=>{this.changeLanguage(LANGUAGES.VI)}  }>VN</span></div>
                            <div className="language-en"><span onClick={ (event)=>{this.changeLanguage(LANGUAGES.EN)}} >EN</span></div>
                        </div>
                    </div>
                </div>
                    {/* {Space Fragment} */}
                    ...
                    <div className="content-up">
                        <div className="title">
                            <div className="title-text">
                                <b><FormattedMessage id="banner.title1"/></b>
                            </div>
                            <div className="title-text">
                        ...
                        <div className="search">
                            <div className="search-content">
                                ...
                                <input type="text" placeholder="Tìm chuyên khoa khám bệnh" name="" value="" />
                            </div>
                        </div>
                    </div>
                    {/* Line */}
                    ...
                    <div className="content-down">
                        <div className="options">
                            <div className="option-child">
                                 ...
                                 <div className="text-child"><FormattedMessage id="banner.bannerp1"/></div>
                            </div>
                            <div className="option-child">
                                 <div className="icon-child"><i className="fas fa-procedures"></i></div>
                                 <div className="text-child"><FormattedMessage id="banner.bannerp2"/></div>
                            </div>
                            <div className="option-child">
                                 <div className="icon-child"><i className="fas fa-hospital"></i></div>
                                 <div className="text-child"><FormattedMessage id="banner.bannerp3"/></div>
                            </div>
                            <div className="option-child">
                                 <div className="icon-child"><i className="fas fa-microscope"></i></div>
                                 <div className="text-child"><FormattedMessage id="banner.bannerp4"/></div>
                            </div>
                            <div className="option-child">
                                 <div className="icon-child"><i className="fas fa-user-md"></i></div>
                                 <div className="text-child"><FormattedMessage id="banner.bannerp5"/></div>
                            </div>
                            <div className="option-child">
                                 <div className="icon-child"><i className="fas fa-tooth"></i></div>
                                 <div className="text-child"><FormattedMessage id="banner.bannerp6"/></div>
                            </div>
                        </div>
                    </div>
...
const mapDispatchToProps = (dispatch) => { // hàm này dùng để ánh xạ actioncreator changeLanguageApp vào prop 
  return {                                 // nhờ dispatch để gữi action có tên changeLanguageApp đến ReduxStore
